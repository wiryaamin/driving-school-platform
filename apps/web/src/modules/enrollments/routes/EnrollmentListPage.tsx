...
import { Search, ClipboardList, ChevronRight, ChevronLeft, Users } from 'lucide-react';
import {
  useEnrollmentList,
...
export function EnrollmentListPage() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-6xl mx-auto">
      ...
      {/* Cross-link — see LeadsPage.tsx for the matching note in the other
          direction. Enrollment requests come from the catalog/checkout
          flow (package interest); booking-form leads are a separate list. */}
      <Link
        to="/leads"
        className="mb-4 flex items-center gap-2.5 rounded-xl border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm text-gray-500 hover:text-gray-700 hover:border-gray-300 transition-colors"
      >
        <Users className="w-4 h-4 shrink-0" />
        <span>Intresseanmälningar via bokningsformuläret visas under <strong className="text-gray-700 font-medium">Leads</strong>, inte här.</span>
      </Link>
