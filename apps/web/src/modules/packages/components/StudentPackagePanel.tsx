...
import { Package, ChevronDown, ChevronUp, AlertTriangle, CheckCircle2, Clock, XCircle, RotateCcw, Minus } from 'lucide-react';
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <p className="text-xs text-muted-foreground/70 mt-1">
          Paket tilldelas automatiskt när en anmälan omvandlas till elev.
        </p>
      </div>
    );
  }
