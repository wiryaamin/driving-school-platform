...
const STATUS_CLASS: Partial<Record<LessonSlotStatus, string>> = {
  ...
  full:        'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400 border-transparent',
  in_progress: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400 border-transparent',
