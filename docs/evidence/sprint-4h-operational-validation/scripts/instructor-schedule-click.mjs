...
await page.goto('http://localhost:5173/scheduling/mine', { waitUntil: 'domcontentloaded' });
await page.waitForTimeout(2500);
console.log('url:', page.url());
await page.screenshot({ path: `${SS}/20-instructor-mitt-schema.png`, fullPage: true });
